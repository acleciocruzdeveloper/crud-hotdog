...
import com.api.greedog.repositories.ClienteRepository;
import com.api.greendog.domain.Cliente;
...
public class RepositoryTest implements ApplicationRunner {
	...
	@Override
	public void run(ApplicationArguments apliApplicationArguments) throws Exception {
